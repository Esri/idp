...
> Also, please note that custom query parameters should not be used for any property value, since they should be generated by the Relying Party\Service Provider (ArcGIS).
> Please see the OpenID Specification for more information:
